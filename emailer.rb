...
class Emailer
  ...
  attr_accessor :smtp_server, :domain, :account_address, :from_address, :account_password, :port

  def initialize(smtp_server, domain, account_address, from_address, account_password, port = 587)
